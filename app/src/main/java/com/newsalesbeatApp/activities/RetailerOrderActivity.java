...
//        window.setStatusBarColor(ContextCompat.getColor(this, R.color.colorPrimaryDark)); // your dark color
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(Color.TRANSPARENT);     // Optional: make status bar transparent
        }
        /*if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            final View bottomLayout = findViewById(R.id.llOrderConfirmation);

            rootView.setOnApplyWindowInsetsListener((v, insets) -> {
                Insets systemBars = insets.getInsets(WindowInsets.Type.systemBars());
                v.setPadding(0, systemBars.top, 0, 0); // Status bar padding
                bottomLayout.setPadding(0, 0, 0, systemBars.bottom); // Navigation bar padding
                return insets;
            });
            ...
            ViewCompat.setOnApplyWindowInsetsListener(rootView, new OnApplyWindowInsetsListener() {
                ...
                public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                    ...
                    v.setPadding(0, topInset, 0, 0); // Status bar padding
                    bottomLayout.setPadding(0, 0, 0, bottomInset); // Navigation bar padding
