...
public class HorizontalStackBarChartView2 extends BaseStackBarChartView2 {

    public HorizontalStackBarChartView2(Context context, AttributeSet attrs) {
    ...
    public HorizontalStackBarChartView2(Context context) {
