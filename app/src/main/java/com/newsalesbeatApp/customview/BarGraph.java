...
public class BarGraph extends View implements HoloGraphAnimate {
    ...
    private ArrayList<MyBar> mBars = new ArrayList<MyBar>();
    ...
    public ArrayList<MyBar> getBars() {
        return mBars;
    }

    public void setBars(ArrayList<MyBar> points) {
        mBars = points;
        postInvalidate();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        NinePatchDrawable popup = (NinePatchDrawable) resources.getDrawable(R.drawable.message);
        ...
        for (final MyBar bar : mBars) {   //calculate total widths of bars being inserted/deleted
            if (bar.mAnimateSpecial == ANIMATE_INSERT) {
