...
public class BaseStackBarChartView2 extends BaseBarChartView {
    ...
    public BaseStackBarChartView2(Context context, AttributeSet attrs) {
    ...
    public BaseStackBarChartView2(Context context) {
