...
public class DuoDrawerToggle implements DrawerLayout.DrawerListener {
     ...
     * <p>
     * <p>The given {@link Activity} will be linked to the specified {@link androidx.core.widget.DrawerLayout} and
     ...
     * <p>
     * The given {@link Activity} will be linked to the specified {@link androidx.core.widget.DrawerLayout} and
    ...
    public interface Delegate {
        ...
        /**
         * Set the Action MyBar's up indicator drawable and content description.
         *
        ...
        /**
         * Set the Action MyBar's up indicator content description.
         *
         * @param contentDescRes - Content description to set
         */
