...
public class VisitedRetailerList extends Fragment {
    ...
    private void calculateTcPCAndSale() {
        ...
        try {
            ...
            newRetTC.clear();
            newRetTC.addAll(hs2);
//            Log.d("TAG", "calculateTcPCAndSale: "+newRetTC.size());
//            RetailerActivity.tvNc.setText(String.valueOf(newRetTC.size()));
    ...
    private ArrayList<ArrayList<String>> getOrderPlacedForDistributorList(ArrayList<RetailerItem> visitedRetailerList) {
        ...
        for (int i = 0; i < visitedRetailerList.size(); i++) {
            ...
            Cursor disPlacedBy = salesBeatDb.getOrderTypeFromOderPlacedByRetailersTable(visitedRetailerList.get(i).getRetailerId());
    ...
    private ArrayList<RetailerItem> getVisitedRetailerList() {
        ...
        Cursor orderPlacedByRetailer = salesBeatDb.
                getRetailersFromOderPlacedByRetailersTable();
            ...
            if (orderPlacedByList.size() > 0) {
                ...
                for (int i = 0; i < orderPlacedByList.size(); i++) {
                    ...
                    if (visitedRetailerCursor != null && visitedRetailerCursor.getCount() > 0
                        ...
                        visitedRetailerItem.setServerStatusCode(orderType.getString(orderType.getColumnIndex(SalesBeatDb.KEY_STATUS_CODE)));
                        visitedRetailerItem.setErrorMsg(orderType.getString(orderType.getColumnIndex(SalesBeatDb.KEY_ERROR_MSG)));
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (item.getItemId() == R.id.changeBeat) {
                    ...
                    Log.d("TAG", "onMenuItemClick Refresh");
